# ajs-hw9_2
Домашнее задание к лекции «Math, Regexp, ArrayBuffer» Regexp

[![Build status](https://ci.appveyor.com/api/projects/status/jb4skekkse2myato?svg=true)](https://ci.appveyor.com/project/Mistel-77/ajs-hw9-2)
